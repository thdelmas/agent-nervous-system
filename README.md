...
Each subdirectory (`consciousness-loop/`, `octopus/`, `rem-sleep/`, `immune-check/`, `sunset/`, `playtime/`, `contemplation/`, `proprioception/`, `exteroception/`, `corpus-callosum/`) is the skill's own repo, pinned to a known-good commit.

## Install (Claude Code)

A Claude skill is a folder containing `SKILL.md`. Install all ten globally:
